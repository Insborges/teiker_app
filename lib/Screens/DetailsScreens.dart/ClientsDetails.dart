...
class _ClientsdetailsState extends State<Clientsdetails> {
  ...
  Widget _buildMapCard(String endereco) {
    final mapUrl =
        'https://maps.googleapis.com/maps/api/staticmap?center=${Uri.encodeComponent(endereco)}&zoom=15&size=600x300&markers=color:red%7C${Uri.encodeComponent(endereco)}&key=AIzaSyBGYYzIR73Sxk0GxxcK8dmWgxcxybMSRj0';
